...
class QueryBuilder<T>(
  ...
  internal fun <P> buildCondition(
    ...
    operator.conditionalActuator(
        wrapper,
        resolveColumnName(property, resolveEntityClass(wrapper)),
        value,
        safe,
    )
  }
  ...
  infix fun KProperty1<T, *>.eqOrIsNull(value: Any?) =
      buildCondition(QueryOperator.EqOrIsNull, this, value)
  ...
  infix fun KProperty1<T, *>.neOrNotNull(value: Any?) =
      buildCondition(QueryOperator.Ne, this, value)
  ...
  infix fun KProperty1<T, *>.likeLeft(value: Any?) =
      buildCondition(QueryOperator.LikeLeft, this, value)

  infix fun KProperty1<T, *>.likeRight(value: Any?) =
      buildCondition(QueryOperator.LikeRight, this, value)

  infix fun KProperty1<T, *>.notLike(value: Any?) =
      buildCondition(QueryOperator.NotLike, this, value)

  infix fun KProperty1<T, *>.notLikeLeft(value: Any?) =
      buildCondition(QueryOperator.NotLikeLeft, this, value)

  infix fun KProperty1<T, *>.notLikeRight(value: Any?) =
      buildCondition(QueryOperator.NotLikeRight, this, value)

  infix fun KProperty1<T, *>.between(value: Pair<Any?, Any?>) =
      buildCondition(QueryOperator.Between, this, value)
  ...
  val KProperty1<T, *>.isNotNull: Unit
    get() = buildCondition(QueryOperator.IsNotNull, this, Unit)

  val KProperty1<T, *>.isNull: Unit
    get() = buildCondition(QueryOperator.IsNull, this, Unit)
}
